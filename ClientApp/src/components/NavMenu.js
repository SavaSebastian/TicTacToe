    ...
    return (
      <header className={"backgroundcolor"}>
        <Navbar className="navbar-expand-sm navbar-toggleable-sm ng-white border-bottom box-shadow mb-3" light>
          <Container>
            <NavbarBrand tag={Link} className="text-white" to="/TicTacToeMain">TicTacToe</NavbarBrand>
            ...
            <Collapse className="d-sm-inline-flex flex-sm-row-reverse" isOpen={!stateCollapsed} navbar>
              <ul className="navbar-nav flex-grow">
                ...
                <NavItem>
                  <NavLink tag={Link} className="text-white" to="/MatchHistory">Match History</NavLink>
                </NavItem>
                <NavItem>
